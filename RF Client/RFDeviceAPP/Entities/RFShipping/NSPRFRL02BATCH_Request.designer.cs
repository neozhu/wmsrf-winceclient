...
//  </auto-generated>
// ------------------------------------------------------------------------------
namespace RFDeviceAPP.Common.NSPRFRL02BATCH.Request
{
    using System;
    ...
    {
        public static Utility Create(string fromloc, string toloc)
        {
            Utility utlity = new Utility();
            utlity.UtilityHeader.fromloc = fromloc;
            utlity.UtilityHeader.toloc = toloc;
            return utlity;
        }
    ...
    public partial class UtilityHeader
    {
        ...
        {
            this.procNameField = "NSPRFRL02BATCH";
