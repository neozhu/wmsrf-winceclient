...
//  </auto-generated>
// ------------------------------------------------------------------------------
namespace RFDeviceAPP.Common.NSPRFTM01.Request
{
    using System;
    ...
    public partial class UtilityHeader
    {
        ...
        private string lastlocField;

        private string lasttaskField;

        private string taskoverrideField;

        private string taskdetailkeyField;

        public UtilityHeader()
        {
            this.procNameField = "NSPRFTM01";
        ...
        public string taskoverride
        {
            get
            {
                return this.taskoverrideField;
            }
            set
            {
                this.taskoverrideField = value;
            }
        }
